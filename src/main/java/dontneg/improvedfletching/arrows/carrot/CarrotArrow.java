...
public class CarrotArrow extends ArrowItem {

    public CarrotArrow(Item.Settings settings) {
        super(settings);
    }

    public PersistentProjectileEntity createArrow(World world, ItemStack stack, LivingEntity shooter, @Nullable ItemStack shotFrom) {
        return new CarrotArrowEntity(world, shooter, stack.copyWithCount(1), shotFrom);
    }
